(when (file-exists-p "~/development/clubhouse/backend/tools/elisp")
  (add-to-list 'load-path "~/development/clubhouse/backend/tools/elisp")
  (require 'shortcut-backend)

  (setq shortcut-backend-directory "~/development/clubhouse/backend")
